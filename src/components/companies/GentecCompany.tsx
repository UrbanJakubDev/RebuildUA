...
export function GentecCompany(): JSX.Element {
  ...
  const goToFirstPage = () => {
    ...
    if (iframe) {
      iframe.src =
        '/gentec-presentation.pdf#toolbar=0&navpanes=0&scrollbar=0&view=FitH&statusbar=0&messages=0&page=1'
    }
  }
    ...
    <SimplePageWrapper showBreadcrumbs={false}>
      <div className='relative flex h-full w-full grow flex-col'>
        ...
        >
          ...
          <iframe
            src='/gentec-presentation.pdf#toolbar=0&navpanes=0&scrollbar=0&view=FitH&statusbar=0&messages=0&scrollbar=0'
            width='100%'
            height='100%'
            className='border-0'
            style={{
